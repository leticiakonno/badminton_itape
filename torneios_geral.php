    ...
    <div class="container">
                ...
                <div class="col-sm-6 col-md-4"> <!-- dimensionamento -->
                    <div class="thumbnail" style="width: 36rem;">
                        <a 
                        href="torneios_detalhe.php?id_categoria=<?php echo $row['id_torneio']; ?>" 
                    >
                        <img 
                    ...
                    <h5 class="text-dark" style="font-size: 25px;"><strong><?php echo $row['tipo_torneio']; ?></strong></h5>
                    <p class="text-center"><?php echo $row['descri_torneio']; ?></p>
                    <p>
                        <a 
                            href="torneios_detalhe.php?id_categoria=<?php echo $row['id_torneio']; ?>" 
                            class="btn btntotal" 
