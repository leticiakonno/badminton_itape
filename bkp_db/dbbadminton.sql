    ...
    (2, 7, 'Isabela Galvão', '2004/04/19', '2025/11/17', 'Isinha é uma atleta super talentosa, todos se encantam ao ver ela jogar. Joga na categoria aberta e brilha em quadra!', 'isabela.png','Não'),
    (3, 7, 'Douglas Oliveira', '1997/06/21', '2025/11/17', 'Douglas é o destaque das fintas, joga muito e sempre ajuda todos ao seu redor!', 'douglas.png', 'Não'),
    ...
    (7, 6, 'Julio Paiva', '2007/07/07', '2025/11/17', 'Julio é carismático, simpático e amigo de todos, joga muito e brilha na categoria Sub19.', 'julio.png', 'Não'),
    ...
    (12, 4, 'Theo Maeseki', '2011/02/19', '2025/11/17', 'Theo é um menino esforçado e está brilhando cada vez mais nos torneios na categoria Sub15.', 'theo.png', 'Sim'),
    ...
    (19, 11,'Pedro Lanas', '1979/03/24', '2025/11/17', 'Pedro é um dos atletas mais experientes no esporte, dedicado e determinado!', 'pedrolanas.png', 'Não');
    ...
    INSERT INTO tbparceiros(id_parceiro,nome_parceiro,descri_parceiro,img_parceiro) VALUES
        ...
        (2,'Colégio Dom Bosco de Itapetininga', 'Primeira e fiel apoiadora do badminton na cidade, promovendo o esporte e oferecendo suporte aos atletas.', 'dombosco.jpeg'),
...
(11, 'Atleta de Itapetininga no Sul-Americano', 'Atleta de Itapetininga, Larissa Ueno de 14 anos representará o Brasil no Campeonato Sul-Americano de Badminton', 'A atleta Larissa Takamori Ueno, natural de Itapetininga, foi convocada para integrar a Seleção Brasileira de Badminton e representará o Brasil no Campeonato Sul-Americano de Badminton, que ocorrerá em Santiago, no Chile, entre os dias 04 e 14 de dezembro.\r\n\r\nLarissa, de apenas 14 anos, se destacou nas categorias por equipe e no individual sub-15. Ela é fruto do projeto social de Badminton de Itapetininga, uma parceria entre a secretaria de Esporte, Lazer e Juventude do município e a coordenação do projeto, liderada pela professora Leiko Konno, com o apoio de sua filha Letícia Konno.\r\n\r\nDesde que iniciou no projeto aos 11 anos, Larissa vem se destacando nas competições estaduais e nacionais, conquistando importantes resultados e mostrando grande potencial para a modalidade. Sua dedicação, disciplina e esforço são reflexos do trabalho realizado pela família Konno à frente da modalidade no município, que visa, além de formar atletas, também promover a cidadania e inclusão social por meio do esporte.\r\n\r\nO Campeonato Sul-Americano de Badminton será uma importante oportunidade para Larissa e outros jovens atletas do Brasil se desenvolverem ainda mais, representando o país em uma competição de nível internacional.', 'internacional', 'not11.jpeg', '2026-02-09 21:54:17', 'ativo');
  ...
  \r\n\r\nSuperando Obstáculos
    ...
    (5, 'Daichi Inoue - Treinador Japonês intergra equipe técnica', 'Daichi Inoue, professor de badminton de 34 anos, chega a Itapetininga vindo do Japão por meio do programa JICA (Agência de Cooperação Internacional do Japão), trazendo consigo uma sólida trajetória de mais de 20 anos dedicados ao esporte. Iniciou sua jornada no badminton ainda na infância, desenvolvendo não apenas habilidades técnicas de alto nível, mas também uma profunda compreensão estratégica e disciplinar da modalidade, características marcantes do treinamento esportivo japonês.

    \r\n\r\nAo longo de sua formação, Daichi acumulou experiências como atleta e como orientador, vivenciando diferentes métodos de treinamento, competições e culturas esportivas. Agora, durante os próximos dois anos em Itapetininga, sua missão vai além de ensinar fundamentos técnicos: ele pretende contribuir para a evolução estrutural da equipe local, fortalecer a base formativa dos jovens atletas e promover uma mentalidade de disciplina, respeito e superação dentro e fora das quadras.

    \r\n\r\nCom grande entusiasmo e espírito colaborativo, Daichi acredita que a troca cultural entre Brasil e Japão será um diferencial importante nesse processo. Ele espera não apenas compartilhar seu conhecimento e experiência, mas também aprender com a realidade brasileira, criando uma integração que resulte no crescimento do badminton na cidade e na formação de atletas mais preparados para desafios regionais, nacionais e até internacionais.','daichi.jpg','daichi.mp4');
