...
$busca = processadorBuscas('tbparceiros', $_GET['buscar'], $conn_atletas);?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    ...
    <!-- Abre thumbnail/card -->
     ...
     <?php do{ ?>
                <div class="col-sm-6 col-md-4"> <!-- dimensionamento -->
                    ...
                    <h5 class="text-dark" style="font-size: 25px;"><strong><?php echo $row['nome_parceiro']; ?></strong></h5>
                    <p class="text-center"><?php echo $row['descri_parceiro']; ?></p>
                    <p>
                        <a 
                            href="parceiros_detalhe.php?id_parceiro=<?php echo $row['id_parceiro']; ?>" 
                            class="btn btntotal" 
