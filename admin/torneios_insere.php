...
if ($_POST) {
    ...
    // Upload da imagem
    $img_torneio = ""; // valor padrão

    if (isset($_FILES['img_torneio']) && $_FILES['img_torneio']['error'] == 0) {
    ...
    // Inserção no banco
    $insertSQL = "
        INSERT INTO tbtorneios (tipo_torneio, descri_torneio, img_torneio)
        VALUES ('$tipo_torneio', '$descri_torneio', '$img_torneio')
    ";
        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-6">
            ...
            <div class="thumbnail">
                <div class="alert alert">
                    <form action="torneios_insere.php"
