    ...
    <h1 class="fundoatletas text-center titulo"><strong><i>Lista de Notícias</i></strong></h1>
        ...
        <table class="table table-hover table-condensed tabela-branca fontetabela">
            ...
            <tr>
                ...
                <td>
                    <a href="noticias_atualiza.php?id_noticia=<?php echo $row['id_noticia']; ?>"
                        target="_self"
                    ...
                    <button
                        data-id="<?php echo $row['id_noticia']; ?>"
                        data-nome="<?php echo $row['titulo_noticia']; ?>"
...
<script type="text/javascript">
    $('.delete').on('click',function(){
        ...
        $('a.delete-yes').attr('href','noticias_exclui.php?id_noticia='+id);
