...
if ($_POST) {
    ...
    // Upload da imagem
    $img_noticia = ""; // valor padrão

    if (isset($_FILES['img_noticia']) && $_FILES['img_noticia']['error'] == 0) {
    ...
    // Inserção no banco
    $insertSQL = "
        INSERT INTO tbnoticias (titulo_noticia, descri_noticia, img_noticia)
        VALUES ('$titulo_noticia', '$descri_noticia', '$img_noticia')
    ";
...
<main class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-offset-3 col-md-6">
            ...
            <div class="thumbnail">
                <div class="alert">
                    <form action="noticias_insere.php"
